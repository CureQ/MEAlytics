MEAlytics allows the user to inspect the results after the analysis has been completed. In the sidebar, navigate to **View Results**.

<img src="../assets/images/view_results.png" width="90%" height="90%"> 

Here, select the output folder that was generated by the analysis. Next, select the raw data file that was used for the experiment. Then press **Load Results**.
 
This window contains three tabs, Single Electrode View, Whole Well View and [Heatmap](heatmap.md).
