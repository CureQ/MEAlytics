...
Similar to the [Inspect results](view_results.md) section, first navigate to **View Results** in the sidebar. Here select both the outputfolder generated by the analysis, and the raw data file that was used. Then, navigate to the third tab named **Heatmap** and open a new window for the heatmap using the button that is presented.<br>
