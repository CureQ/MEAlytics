...
By ticking **Compress all .h5 files in same folder** the application will loop through all files in the parent directory and apply the rechunking and compression.
